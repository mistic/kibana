...
function getServerListener(server) {
  return server._server.listener;
}
...
describe('when run within legacy platform', () => {
  let newPlatformProxyListenerMock;
  beforeEach(() => {
    ...
    newPlatformProxyListenerMock.proxy.mockImplementation((req, res) => {
