...
load("@build_bazel_rules_nodejs//:providers.bzl", "DeclarationInfo", "NpmPackageInfo", "LinkablePackageInfo", "js_module_info", "js_named_module_info")
...
def _js_library_impl(ctx):
    ...
    all_files_depset = depset([
        ...
        depset(transitive = sources_depsets)
    ])
    ...
    if ctx.attr.package_name:
        ...
        providers.append(LinkablePackageInfo(
            ...
            path = path,
            files = all_files_depset,
        ))

    if ctx.attr._npm_package:
