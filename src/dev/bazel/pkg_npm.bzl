...
Target @build_bazel_rules_nodejs//:my_package up-to-date:
...
PKG_NPM_ATTRS = {
    ...
    "_npm_script_generator": attr.label(
        default = Label("@build_bazel_rules_nodejs//internal/pkg_npm:npm_script_generator"),
        cfg = "host",
        executable = True,
    ),
    "_packager": attr.label(
        default = Label("@build_bazel_rules_nodejs//internal/pkg_npm:packager"),
        cfg = "host",
        executable = True,
    ),
